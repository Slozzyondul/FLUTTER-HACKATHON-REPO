    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: Icon(
          ...
          color:
              const Color.fromARGB(255, 98, 165, 224), // Set icon color to blue
        ),
        title: Text(
        ...
        trailing: Container(
          ...
          decoration: BoxDecoration(
            color: Color.fromARGB(255, 255, 255,
                255), // Set background color of the delete button container to sky blue
          ...
          child: IconButton(
            ...
            icon: Icon(
              ...
              color: const Color.fromARGB(
                  255, 98, 165, 224), // Set icon color to white
            ),
          ),
        ),
      ),
